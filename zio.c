/* #ident	"@(#)x11:contrib/clients/xloadimage/zio.c 6.15 94/07/29 Labtam" */
/* zio.c:
 *
...
FILE *popen();		/* ANSI C doesn't declare popen in stdio.h ! */
