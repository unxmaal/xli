/* #ident   "@(#)x11:contrib/clients/xloadimage/jpeg.h 1.10 93/07/23 Labtam" */

#ifndef JPEG_H
#define JPEG_H

/*
 * This is based on jinclude.h, jconfig.h + other stuff,
 * customized for use with xli.
 */

/*************************************************************************/
/*
 * jinclude.h, modified for xloadimage use
 *
...
/*************************************************************************/
/*
 * jconfig.h, modified for xloadimage use
 *
 * Copyright (C) 1991, 1992, 1993, Thomas G. Lane.
 * This file is part of the Independent JPEG Group's software.
 * For conditions of distribution and use, see the accompanying README file.
...
#undef PROTO			/* xloadimage does not use function protos */
...
#undef NEED_FAR_POINTERS	/* xloadimage does not run under MessyDOS */
...
#ifdef FIX	/* Fudge to get jpeglib.c to compile without changes */
#undef FIX
#endif
