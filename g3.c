/* #ident	"@(#)x11:contrib/clients/xloadimage/g3.c 6.12 94/07/29 Labtam" */
...
tryagain:
    ...
    /* Now get three lines and make sure they are the same length.  If not give up.
...

Image	*g3Load(fullname, image_ops, verbose)
